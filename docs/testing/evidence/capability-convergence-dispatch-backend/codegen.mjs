...
const repo = process.argv[2] ?? '/private/tmp/fdlc-program-dispatch';
const backendBinary = '/Users/jaywest/.cache/convex/binaries/precompiled-2026-08-25-7cce8fb/convex-local-backend';
const runRoot = mkdtempSync('/private/tmp/fdlc-dispatch-codegen-');
...
const fixtureSource = readFileSync('/private/tmp/fdlc-dispatch-authority-harness/fixture.ts', 'utf8') + `import { mutationGeneric as mutation, queryGeneric as query } from 'convex/server';
import { v } from 'convex/values';
...
const env = { PATH: process.env.PATH, TMPDIR: '/private/tmp', CI: '1', CONVEX_OVERRIDE_ACCESS_TOKEN: 'synthetic-not-an-access-token', CONVEX_SELF_HOSTED_URL: url, CONVEX_SELF_HOSTED_ADMIN_KEY: adminKey, SENTRY_DSN: '', DISABLE_BEACON: '1', NODE_OPTIONS: '--import=/private/tmp/fdlc-dispatch-authority-harness/loopback-only.mjs' };
