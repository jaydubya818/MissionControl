...
The main-thread data-integrity/architecture/simplicity follow-up confirms that this guard reuses the existing lease and protected workspace ownership records. It creates no new execution authority or alternative publication path. Final clean-checkout System Qualification is recorded separately against its exact committed source.
