...
const runRoot = mkdtempSync('/private/tmp/fdlc-identity-backend-');
...
const env = { PATH: process.env.PATH, TMPDIR: '/private/tmp', CI: '1', CONVEX_OVERRIDE_ACCESS_TOKEN: 'synthetic-not-an-access-token', CONVEX_SELF_HOSTED_URL: url, CONVEX_SELF_HOSTED_ADMIN_KEY: adminKey, SENTRY_DSN: '', DISABLE_BEACON: '1', NODE_OPTIONS: '--import=/private/tmp/fdlc-identity-authority-harness/loopback-only.mjs' };
