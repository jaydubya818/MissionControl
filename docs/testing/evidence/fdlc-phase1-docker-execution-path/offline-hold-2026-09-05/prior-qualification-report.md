...
**Required administrative input:** the dedicated qualification AWS account ID, project/environment identifier and approved role ARN or configuration location. Do not paste secret keys. The approved provider/model is fixed; it is not being reopened.
