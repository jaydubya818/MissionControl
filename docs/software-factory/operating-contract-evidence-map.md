...
| Outcomes propose changes without promoting them | Learning | [Factory Learning](../../convex/factoryLearning.ts), [learning tests](../../convex/__tests__/factoryLearning.test.ts) | Qualified advisory behavior; production learning coverage and promotion remain separately governed |
