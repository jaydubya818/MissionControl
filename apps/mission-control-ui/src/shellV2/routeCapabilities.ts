...
export const ROUTE_CAPABILITIES: Partial<Record<MainView, RouteCapability>> = {
  ...
  "registry-lifecycle": { scope: "workspace", maturity: "live" },
  "registry-evaluate": { scope: "workspace", maturity: "live" },
  "registry-inventory": { scope: "workspace", maturity: "live" },
  "registry-installations": { scope: "workspace", maturity: "live" },
  "registry-runs": { scope: "workspace", maturity: "live" },
