...
export const ConvexActions = {
  serviceCommands: {
    ...
    persistInferenceIntent: "serviceCommands:persistInferenceIntent",
    claimInferenceIntent: "serviceCommands:claimInferenceIntent",
    appendInferenceReceipt: "serviceCommands:appendInferenceReceipt",
    appendInferenceReconciliation: "serviceCommands:appendInferenceReconciliation",
