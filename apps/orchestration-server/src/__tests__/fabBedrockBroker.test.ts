...
const route = {
  ...
  maximumContextTokens: 1_000_000 as const,
  capabilities: { countTokens: { status: "UNSUPPORTED" as const, evidenceReference: "fixture://counttokens-unsupported", evidenceDigest: `sha256:${"e".repeat(64)}` } },
  ...
  expectedStsPrincipalArn: "arn:aws:sts::123456789012:assumed-role/qualification/test",
};
const price: ProviderPrice = {
  ...
  source: "https://fixture.invalid/fab-price",
...
const priceDigest = liabilityDigest(price);
