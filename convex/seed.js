...
exports.getSeededStatus = exports.clearAll = exports.seedV0 = void 0;
    ...
    handler: async (ctx) => {
        ...
        for (const config of agentConfigs) {
            const agentId = await ctx.db.insert("agents", {
                ...
                metadata: config.isCAO ? { isCAO: true, role: "Chief Agent Officer" } : undefined,
            });
