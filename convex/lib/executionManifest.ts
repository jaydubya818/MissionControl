...
function compileFactoryPrompt(
  ...
  return [
    ...
    "Do not block on live package installation or registry access. Write package manifests and a lockfile when the Work Order needs them. The Factory worker installs frozen dependencies after you return. Never write node_modules.",
