...
export default defineSchema({
  ...
  changeRecords: defineTable({
    ...
    type: v.union(
      ...
      v.literal("WORKFLOW_RUN_STARTED"),
      v.literal("WORKFLOW_CANCELLATION_REQUESTED"),
      v.literal("RUN_ARTIFACT_LINKED"),
      ...
      v.literal("AGENT_DOCUMENT_CREATED"),
      v.literal("AGENT_DOCUMENT_UPDATED"),
      v.literal("AGENT_DOCUMENT_DELETED"),
      v.literal("ALERT_CREATED"),
      v.literal("ALERT_ACKNOWLEDGED"),
      v.literal("ALERT_RESOLVED"),
      v.literal("ALERT_IGNORED"),
