...
- Independent architecture/simplicity, security, and data-integrity re-reviews
  ...
  passes 256 tests,
  documentation consistency, and the unchanged runtime-contract v55 guard.
  Accounting/data-integrity re-review, source publication, CI, merge,
  exact-main qualification, and the one bounded live call remain pending.
