...
describe("factory documentation consistency", () => {
  ...
  it("rejects runtime-version and maturity-plan drift", () => {
    ...
    writeFileSync(readmePath, readFileSync(readmePath, "utf8").replace("runtime contract: **v40**", "runtime contract: **v39**"));
    ...
    expect(result.findings).toContain("README.md: runtime contract v39 does not match source v40");
