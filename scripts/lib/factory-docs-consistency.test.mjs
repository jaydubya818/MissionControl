...
describe("factory documentation consistency", () => {
  ...
  it("rejects runtime-version and maturity-plan drift", () => {
    ...
    writeFileSync(readmePath, readFileSync(readmePath, "utf8").replace("runtime contract: **v37**", "runtime contract: **v36**"));
    ...
    expect(result.findings).toContain("README.md: runtime contract v36 does not match source v37");
