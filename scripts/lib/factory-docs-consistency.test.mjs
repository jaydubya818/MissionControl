...
describe("factory documentation consistency", () => {
  ...
  it("rejects runtime-version and maturity-plan drift", () => {
    ...
    writeFileSync(readmePath, readFileSync(readmePath, "utf8").replace("runtime contract: **v43**", "runtime contract: **v42**"));
    ...
    expect(result.findings).toContain("README.md: runtime contract v42 does not match source v43");
